...
class NWPUv2Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.proposals is not None:
            ...
            #else:
            # 11.22修改：因为dior的proposal的index是5位字符串，要保留原样才能在76查到
    ...
    def map_class_id_to_class_name(self, class_id):
        return NWPUv2Dataset.CLASSES[class_id]
