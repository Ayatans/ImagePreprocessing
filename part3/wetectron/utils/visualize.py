...
DIOR_CATEGORIES = ["__background__ ", 'airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge', 'chimney',
...
NWPU_CATEGORIES=["__background__ ", 'airplane', 'baseballdiamond', "basketballcourt", "bridge", "groundtrackfield",
               "harbor", "ship", "storagetank", 'tenniscourt', "vehicle"]

NWPUv2_CATEGORIES=["__background__ ", 'airplane', 'baseballdiamond', "basketballcourt", "bridge", "groundtrackfield",
               "harbor", "ship", "storagetank", 'tenniscourt', "vehicle"]
...
def vis_results(
    ...
    for prediction, img_info in zip(predictions, img_infos):
        ...
        if show_mask_heatmaps:
            ...
            elif 'DIOR' in data_path:
                CATEGORIES = DIOR_CATEGORIES
            elif 'NWPUv2' in data_path:
                CATEGORIES = NWPUv2_CATEGORIES
            elif 'NWPU' in data_path:
                CATEGORIES = NWPU_CATEGORIES
            else:
                raise ValueError
