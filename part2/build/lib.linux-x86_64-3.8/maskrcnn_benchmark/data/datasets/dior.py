...
class DIORDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, use_difficult=False, transforms=None, toofew=True, seed=0):
        ...
        if 'split1_base' in split:
            cls = DIORDataset.CLASSES_SPLIT1_BASE
        elif 'split2_base' in split:
            cls = DIORDataset.CLASSES_SPLIT2_BASE
        elif 'split3_base' in split:
            cls = DIORDataset.CLASSES_SPLIT3_BASE
        elif 'split4_base' in split:
            cls = DIORDataset.CLASSES_SPLIT4_BASE
        elif 'split5_base' in split:
            cls = DIORDataset.CLASSES_SPLIT5_BASE
        else:
