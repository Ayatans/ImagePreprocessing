...
_C.MODEL.RPN.ANCHOR_SIZES = (64, 128, 256)
# Stride of the feature map that RPN is attached.
# For FPN, number of strides should match number of scales
_C.MODEL.RPN.ANCHOR_STRIDE = (8,)
...
_C.MODEL.ROI_WEAK_HEAD.PREDICTOR = "MISTPredictor"  # may ablation
_C.MODEL.ROI_WEAK_HEAD.LOSS = "RoIRegLoss"
_C.MODEL.ROI_WEAK_HEAD.OICR_P = 0.15
_C.MODEL.ROI_WEAK_HEAD.REGRESS_ON = False
_C.MODEL.ROI_WEAK_HEAD.REGRESS_HEUR = "AVG"     # may ablation
# for partial labels
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "output/" + 'archived_' + time.strftime("%Y-%m-%d_%H:%M:%S", time.localtime())
_C.cluster = 5
_C.nms = 0.1
_C.lmda = 0.1
_C.pos_update = 0
