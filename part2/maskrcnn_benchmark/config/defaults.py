...
# _C.INPUT.PIXEL_MEAN = [92.5145, 102.0556, 99.2297]  # dior trainval
# _C.INPUT.PIXEL_MEAN = [92.2753, 101.3056, 98.3298]  # dior all

# Values to be used for image normalization
_C.INPUT.PIXEL_STD = [1., 1., 1.]
# _C.INPUT.PIXEL_STD = [48.2278, 47.8905, 51.6829] # dior trainval
# _C.INPUT.PIXEL_STD = [47.5736, 47.2543, 50.9380] # dior all
...
# backbone)
_C.MODEL.BACKBONE.CONV_BODY = "R-50-C4" # override
...
# ---------------------------------------------------------------------------- #
_C.MODEL.RPN = CN()
_C.MODEL.RPN.USE_FPN = False    # override
_C.MODEL.RPN.FREEZE = False
_C.MODEL.DENSE_RELATION = False
_C.MODEL.DENSE_SUM = False
_C.MODEL.MULTI_LEVEL = False
_C.MODEL.LAYER3 = False
_C.MODEL.LAYER1 = False
_C.MODEL.LAYER0 = False
_C.MODEL.SEED = 0
_C.MODEL.VIS = False
# Base RPN anchor sizes given in absolute pixels w.r.t. the scaled network input
# RPN上的anchor size对应的是原图上的尺寸。
_C.MODEL.RPN.ANCHOR_SIZES = (32, 64, 128, 256, 512)  #(24, 96, 200, 360, 640)
# Stride of the feature map that RPN is attached.
# For FPN, number of strides should match number of scales
_C.MODEL.RPN.ANCHOR_STRIDE = (16,)
# RPN anchor aspect ratios
_C.MODEL.RPN.ASPECT_RATIOS = (0.5, 1.0, 2.0) #(0.25, 0.5, 1.0, 2.0, 4.0) #(0.2, 0.5, 1.0, 2.0, 5.0)
...
_C.MODEL.RPN.NMS_THRESH = 0.7   # 已经和fsce同了
...
_C.MODEL.ROI_HEADS.USE_FPN = False  # override
...
_C.MODEL.ROI_BOX_HEAD.FREEZE_FEAT = False
...
_C.MODEL.ROI_BOX_HEAD.NUM_ALL_CLASSES = 81
...
# existed above, so zhushi.
# _C.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION = 14
# set sampling ratio to 0 to sample densely, existed above, so zhushi.
# _C.MODEL.ROI_BOX_HEAD.POOLER_SAMPLING_RATIO = 0
...
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.USE_CONTRASTIVE_BRANCH = False  # True 则用Contrastive Branch，False则原ROIBoxHead
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.MLP_FEATURE_DIM =128 #256  # 初始128
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.TEMPERATURE = 0.5 #0.05  # 带CL的都是0.2， default 0.1
...
_C.MODEL.RESNETS.BACKBONE_OUT_CHANNELS = 256 * 4    # backbone can not change
...
# visualize results when inferring
...
_C.TEST.BBOX_AUG.ENABLED = True

# Horizontal flip at the original scale (id transform)
_C.TEST.BBOX_AUG.H_FLIP = True

# Each scale is the pixel size of an image's shortest side
_C.TEST.BBOX_AUG.SCALES = (480, 576, 688, 864, 1000, 1200) #(400, 800, 1200)

# Max pixel size of the longer side
_C.TEST.BBOX_AUG.MAX_SIZE = 4000

# Horizontal flip at each scalee
_C.TEST.BBOX_AUG.SCALE_H_FLIP = True
...
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "."
_C.SAVE_ATTENTION_DIR = "save_attentions/"
